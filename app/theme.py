...
/* ---- top bar / filter row (1c layout) ---- */
QFrame#topBar {
    background: %(window)s;
    border: none; border-bottom: 2px solid %(border)s;
}
QFrame#filterRow {
    background: %(panel)s;
    border: none; border-bottom: 2px solid %(border)s;
...
QToolButton:hover { border-color: %(muted)s; background: %(hover)s; }
QToolButton::menu-indicator { image: none; }

/* ---- inspector ---- */
QWidget#inspectorPanel { background: %(panel)s; }
